...
OUTPUT_JSON="${OUTPUT_JSON:-/home/zhuyangkun/data/vllm_a1/qwena1_validation_outputs/compare_debug.json}"
...
SEED="${SEED:-1234}"
DEBUG_THRESHOLD="${DEBUG_THRESHOLD:-1e-6}"
...
python "$ROOT_DIR/compare_qwena1_integrated_vs_standalone.py" \
  ...
  --debug-compare \
  --debug-threshold "$DEBUG_THRESHOLD" \
