...
OUTPUT_JSON="${OUTPUT_JSON:-/home/zhuyangkun/data/vllm_a1/qwena1_validation_outputs/compare_sdpa_vs_eager.json}"
...
python "$ROOT_DIR/compare_qwena1_attention_backends.py" \
  --model-dir "$MODEL_DIR" \
