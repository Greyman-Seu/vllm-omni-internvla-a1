...
class Qwen3VLVisionModel(Qwen3VLPreTrainedModel):
    ...
    _repeated_blocks = ["Qwen3VLVisionBlock"]
...
class Qwen3VLModel(Qwen3VLPreTrainedModel):
    ...
    def get_rope_index(
        ...
        """Different from the original implementation, Qwen3VL uses timestamps rather than absolute time ids."""

        # We use timestamps to separate videos, so video_grid_thw should also be split.
    ...
    def get_video_features(
        ...
        """
        Encodes videos into continuous embeddings that can be forwarded to the language
        model. The deepstack visual features are also returned.
    ...
    def get_image_features(
        ...
        """
        Encodes images into continuous embeddings that can be forwarded to the language
        model. The deepstack visual features are also returned.
    ...
    def get_placeholder_mask(
        ...
        and checks that the placeholder token count matches the multimodal features.
        """
        ...
        if video_features is not None and inputs_embeds[special_video_mask].numel() != video_features.numel():
            raise ValueError(
                "Videos features and video tokens do not match: "
...
class Qwen3VLForConditionalGeneration(Qwen3VLPreTrainedModel, GenerationMixin):
    ...
    def _get_image_nums_and_video_nums(
        ...
        These parameters are not passed through the processor to avoid unpredictable impacts from interface
        modifications.
